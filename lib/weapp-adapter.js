...
!function(e) {
	...
	}, t.ontouchstart = null, t.ontouchmove = null, t.ontouchend = null, t.pageXOffset = 0, t.pageYOffset = 0;
}, function(t, n, o) {
	function r(e, t) {
	...
	var u = function() {
			...
			return a(t, c.default), u(t, [ {
					...
					get: function() {
							...
							return Number.isNaN(e) ? this.width : e;
					}
			}, {
					key: "clientHeight",
					get: function() {
							var e = parseInt(this.style.fontSize, 10);
							return Number.isNaN(e) ? this.height : e;
					}
			} ]), t;
	}();
	n.default = f;
